...
class DHondtCalculator(QMainWindow):
    ...
    def create_header_controls(self, main_layout):
        ...
        self.election_name_edit.setMaximumWidth(200)
    ...
    def create_table(self, main_layout):
        ...
        self.table.setColumnWidth(0, 60)  # Seats column
        self.table.setColumnWidth(1, 160)  # Party name column
        self.table.setColumnWidth(2, 100)  # Votes column
        ...
        for row in range(self.max_parties):
            ...
            party_edit.setPlaceholderText("Enter party name")
            ...
            vote_edit.setPlaceholderText("Enter votes")
        ...
        for party_idx, votes in enumerate(vote_values):
            for div in range(1, self.divisors + 1):
                ...
                if votes > 0:
                    ...
                    item.setText("0")
                item.setBackground(QBrush(QColor(255, 255, 255)))  # Reset background
